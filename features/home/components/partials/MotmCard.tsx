...
import type { Motm as MotmType } from "@/features/home/data/types";
    ...
    <div className={`mx-auto flex max-w-4xl flex-col justify-evenly gap-4 sm:flex-row`}>
      ...
      <div className="flex flex-col items-center gap-4 p-3 text-center sm:items-start sm:text-left">
        ...
        <p className="max-w-[540px]">
          This month&apos;s spotlight celebrates an outstanding member whose dedication, innovation,
          and teamwork have made a lasting impact. Your exceptional contributions continue to
          inspire us all and set the standard for excellence!
        </p>
