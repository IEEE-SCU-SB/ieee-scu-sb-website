			...
			<main>
				{recruitment.status === "open" && (
					<section className='grid md:grid-cols-2 gap-12'>
						<Image className='mx-auto w-full max-w-xs md:max-w-md md:order-2' src={hiringIllustration} alt='We Are Hiring Illustration' />
						...
						<div className='flex flex-col gap-6 justify-center max-w-2xl text-center md:text-left'>
							...
							<p className='md:text-lg'>
								Ready to make an impact? <strong>Join us</strong> and become part of our dynamic team. Apply now and take the first step toward an
							...
							<a
								...
								className='btn-primary bg-primary text-white inline-block'
							>
				...
				{recruitment.status !== "open" && (
					<section className='grid md:grid-cols-2 gap-12'>
						...
						>
							<rect x='9.49805' y='83.2961' width='308.72' height='324.241' rx='14' transform='rotate(-7.5 9.49805 83.2961)' fill='black' />
							<rect
								x='0.560986'
								y='78.9085'
								width='309.124'
							...
							<defs>
								...
								>
									...
									<feBlend mode='normal' in2='BackgroundImageFix' result='effect1_dropShadow_391_1372' />
									<feBlend mode='normal' in='SourceGraphic' in2='effect1_dropShadow_391_1372' result='shape' />
								</filter>
								<filter
								...
								<linearGradient id='paint0_linear_391_1372' x1='295.427' y1='386.698' x2='115.499' y2='94.7145' gradientUnits='userSpaceOnUse'>
						...
						<div className='flex flex-col justify-center gap-6 max-w-2xl text-center md:text-left'>
							...
							<p className='md:text-lg'>Stay tuned for updates—we&apos;ll be back soon with exciting opportunities!</p>
